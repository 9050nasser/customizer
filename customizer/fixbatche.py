        ...
        for item in invoice_items:
            ...
            if has_batch_no:
                if item['parent'] not in items_by_parent:
                    items_by_parent[item['parent']] = set()  # Use a set to ensure distinct items
                items_by_parent[item['parent']].add(item['item_code'])
    
    # Print the parent and the list of distinct item codes under it
