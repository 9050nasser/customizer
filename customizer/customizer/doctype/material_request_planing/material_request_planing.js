			...
			frm.add_custom_button(__('Create Material Request'), function() {
				frappe.model.with_doctype('Material Request', function() {
					...
					items.forEach(function(item) {
						...
						mr_item.warehouse = item.t_warehouse;
...
frappe.ui.form.on('Stock Entry Request Detail', {
...
erpnext.stock.StockEntry = erpnext.stock.StockController.extend({
	...
	get_items_from_source: function(frm) {
		var me = this;
		frappe.call({
			method:"customizer.customizer.doctype.material_request_planing.material_request_planing.get_uniuqe_items",
			args: {
				from_warehouse: me.frm.doc.from_warehouse,
				to_warehouse: me.frm.doc.to_warehouse,
