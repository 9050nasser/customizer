...
class MaterialRequestPlaning(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from erpnext.stock.doctype.material_request_item.material_request_item import MaterialRequestPlaningItem

		amended_from: DF.Link | None
		company: DF.Link
		customer: DF.Link | None
		items: DF.Table[MaterialRequestPlaningItem]
...
@frappe.whitelist()
def get_uniuqe_items(from_warehouse,to_warehouse, posting_date, posting_time=None, company=None):
