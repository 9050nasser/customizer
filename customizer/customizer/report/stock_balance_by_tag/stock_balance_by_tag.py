...
def get_conditions(filters):
	...
	if filters.get("tag"):
		conditions += " and sle.item_code in (select document_name from `tabTag Link` where document_type='Item' and tag = '%s' ) "%(filters.get("tag"))
...
def get_items(filters):
	conditions = []
	if filters.get("tag"):
		conditions.append( "item.item_code in (select document_name from `tabTag Link` where document_type='Item' and tag = '%s' ) "%(filters.get("tag")) )	
