...
def get_conditions(filters):
    ...
    if filters.get("from_time"): conditions += " and si.posting_time>='{0}' ".format(filters.get("from_time"))
    if filters.get("to_time"): conditions += " and si.posting_time<='{0}' ".format(filters.get("to_time"))
...
def get_data(filters):
	...
	all_cs_data = frappe.get_list("Cost Center",filters= [{"is_group":0},{"disabled":0}, {"custom_not_include_report": 0}])
	all_cs = []
