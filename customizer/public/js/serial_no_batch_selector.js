//~ erpnext.CustomSerialNoBatchSelector = Class.extend({
	...
	//~ make_dialog: function() {
		...
		//~ if (this.has_batch && !this.has_serial_no) {
			//~ title = __("Select Batch Numbersjjjjjjjjjjj");
				...
				//~ fields: [
					//~ {
						...
						//~ change: function () {
							...
							//~ let batch_number =this.grid_row.on_grid_fields_dict.batch_no.get_value();
